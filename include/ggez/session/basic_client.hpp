...
namespace ggez::session {
    ...
    class basic<session::model::client, PerStepDataT, ConfigV, MetadataT, StepT> : public impl::basic_base<PerStepDataT, ConfigV, MetadataT, StepT> {
    public:
    ...
    public:
        ...
        constexpr basic(client_model client_model, MetadataT initial_metadata = {}, callbacks_type session_callbacks = {}) noexcept;
...
namespace ggez::session {
    ...
    using basic_client = basic<session::model::client, PerStepDataT, ConfigV, MetadataT, StepT>;
}

namespace ggez {
    template<traits::network_transferrable PerStepDataT, auto ConfigV = session::config_t{}, traits::metadata_like MetadataT = session::metadata_t<ConfigV>, traits::network_transferrable StepT = std::size_t> requires traits::config_like<decltype(ConfigV)>
    using basic_client_session = session::basic_client<PerStepDataT, ConfigV, MetadataT, StepT>;
}
